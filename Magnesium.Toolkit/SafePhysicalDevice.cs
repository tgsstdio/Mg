...
{
	public class SafePhysicalDevice : IMgPhysicalDevice
	{
		internal IMgPhysicalDevice mImpl = null;
		internal SafePhysicalDevice(IMgPhysicalDevice impl)
		{
			mImpl = impl;
		}
		...
		public MgResult GetPhysicalDeviceSurfaceSupportKHR(UInt32 queueFamilyIndex, IMgSurfaceKHR surface, Boolean& pSupported)
		{
			Validation.PhysicalDevice.GetPhysicalDeviceSurfaceSupportKHR.Validate(queueFamilyIndex, surface, pSupported);
			return mImpl.GetPhysicalDeviceSurfaceSupportKHR(queueFamilyIndex, surface, pSupported);
		}
