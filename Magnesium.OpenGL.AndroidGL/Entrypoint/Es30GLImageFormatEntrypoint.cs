...
{
	public class Es30GLImageFormatEntrypoint : IGLImageFormatEntrypoint
	{
		public GLInternalImageFormat GetGLFormat (MgFormat format, bool supportsSRgb)
		{
			...
			case MgFormat.R8G8B8A8_UINT:
				...
				return new GLInternalImageFormat
				{
					InternalFormat = (int) All.Rgba8ui,
					GLFormat = (int) All.RgbaInteger,
					GLType = (int) All.UnsignedByte,
				};
			case MgFormat.R8G8B8A8_SRGB:
				...
				return new GLInternalImageFormat
				{
					InternalFormat = (int) All.Srgb, //(PixelInternalFormat) 0x8C40; // PixelInternalFormat.Srgb;
