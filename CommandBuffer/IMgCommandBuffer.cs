...
namespace Magnesium
{
    ...
    public interface IMgCommandBuffer
	{
		...
		void CmdCopyQueryPoolResults(MgQueryPool queryPool, UInt32 firstQuery, UInt32 queryCount, IMgBuffer dstBuffer, UInt64 dstOffset, UInt64 stride, MgQueryResultFlagBits flags);
