...
namespace Magnesium
{
    ...
    public interface IMgCommandBuffer
	{
		...
		void CmdCopyBufferToImage(MgBuffer srcBuffer, IMgImage dstImage, MgImageLayout dstImageLayout, MgBufferImageCopy[] pRegions);
		void CmdCopyImageToBuffer(IMgImage srcImage, MgImageLayout srcImageLayout, MgBuffer dstBuffer, MgBufferImageCopy[] pRegions);
