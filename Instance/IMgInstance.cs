...
namespace Magnesium
{
    public interface IMgInstance
	{
		...
		Result CreateDebugReportCallbackEXT(MgDebugReportCallbackCreateInfoEXT pCreateInfo, IMgAllocationCallbacks allocator, out MgDebugReportCallbackEXT pCallback);
		void DestroyDebugReportCallbackEXT(MgDebugReportCallbackEXT callback, IMgAllocationCallbacks allocator);
