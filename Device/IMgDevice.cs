...
namespace Magnesium
{
    ...
    public interface IMgDevice
	{
		...
		Result CreateEvent(MgEventCreateInfo pCreateInfo, MgAllocationCallbacks allocator, out IMgEvent @event);
...
//		Result ResetEvent(IMgEvent @event);
		Result CreateQueryPool(MgQueryPoolCreateInfo pCreateInfo, MgAllocationCallbacks allocator, out IMgQueryPool queryPool);
		...
		Result CreateBufferView(MgBufferViewCreateInfo pCreateInfo, MgAllocationCallbacks allocator, out IMgBufferView pView);
		...
		Result CreateRenderPass(MgRenderPassCreateInfo pCreateInfo, MgAllocationCallbacks allocator, out IMgRenderPass pRenderPass);
