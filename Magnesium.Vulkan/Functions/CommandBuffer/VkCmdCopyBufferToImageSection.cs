...
namespace Magnesium.Vulkan.Functions.CommandBuffer
{
	public class VkCmdCopyBufferToImageSection
	{
		...
		internal extern static void vkCmdCopyBufferToImage(IntPtr commandBuffer, UInt64 srcBuffer, UInt64 dstImage, VkImageLayout dstImageLayout, UInt32 regionCount, [In, Out] VkBufferImageCopy[] pRegions);
