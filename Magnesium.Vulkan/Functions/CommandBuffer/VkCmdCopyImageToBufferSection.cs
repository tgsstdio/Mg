...
namespace Magnesium.Vulkan.Functions.CommandBuffer
{
	public class VkCmdCopyImageToBufferSection
	{
		...
		internal extern static void vkCmdCopyImageToBuffer(IntPtr commandBuffer, UInt64 srcImage, MgImageLayout srcImageLayout, UInt64 dstBuffer, UInt32 regionCount, [In, Out] VkBufferImageCopy[] pRegions);
