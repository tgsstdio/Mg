...
namespace Magnesium.Vulkan.Functions.CommandBuffer
{
	public class VkCmdClearColorImageSection
	{
		...
		internal extern static void vkCmdClearColorImage(IntPtr commandBuffer, UInt64 image, VkImageLayout imageLayout, [In, Out] VkClearColorValue pColor, UInt32 rangeCount, [In, Out] VkImageSubresourceRange[] pRanges);
