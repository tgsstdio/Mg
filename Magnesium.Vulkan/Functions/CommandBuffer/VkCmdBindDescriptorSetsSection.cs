...
namespace Magnesium.Vulkan.Functions.CommandBuffer
{
	public class VkCmdBindDescriptorSetsSection
	{
		...
		internal extern static void vkCmdBindDescriptorSets(IntPtr commandBuffer, MgPipelineBindPoint pipelineBindPoint, UInt64 layout, UInt32 firstSet, UInt32 descriptorSetCount, UInt64[] pDescriptorSets, UInt32 dynamicOffsetCount, UInt32[] pDynamicOffsets);
