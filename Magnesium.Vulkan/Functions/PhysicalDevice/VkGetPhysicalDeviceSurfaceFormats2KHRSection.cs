...
namespace Magnesium.Vulkan.Functions.PhysicalDevice
{
	public class VkGetPhysicalDeviceSurfaceFormats2KHRSection
	{
		...
		internal extern static unsafe MgResult vkGetPhysicalDeviceSurfaceFormats2KHR(IntPtr physicalDevice, VkPhysicalDeviceSurfaceInfo2KHR pSurfaceInfo, UInt32* pSurfaceFormatCount, VkSurfaceFormat2KHR* pSurfaceFormats);
