...
namespace Magnesium.Vulkan.Functions.PhysicalDevice
{
	public class VkCreateDisplayModeKHRSection
	{
		...
		internal extern static MgResult vkCreateDisplayModeKHR(IntPtr physicalDevice, UInt64 display, [In, Out] VkDisplayModeCreateInfoKHR pCreateInfo, IntPtr pAllocator, ref UInt64 pMode);
