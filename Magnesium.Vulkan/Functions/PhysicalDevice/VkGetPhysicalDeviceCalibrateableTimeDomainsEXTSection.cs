...
namespace Magnesium.Vulkan.Functions.PhysicalDevice
{
	public class VkGetPhysicalDeviceCalibrateableTimeDomainsEXTSection
	{
		...
		internal extern static MgResult vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(IntPtr physicalDevice, ref UInt32 pTimeDomainCount, MgTimeDomainEXT[] pTimeDomains);
