...
namespace Magnesium.Vulkan.Functions.Device
{
	public class VkCreateSharedSwapchainsKHRSection
	{
		...
		internal extern static MgResult vkCreateSharedSwapchainsKHR(IntPtr device, UInt32 swapchainCount, [In, Out] VkSwapchainCreateInfoKHR[] pCreateInfos, IntPtr pAllocator, UInt64[] pSwapchains);
