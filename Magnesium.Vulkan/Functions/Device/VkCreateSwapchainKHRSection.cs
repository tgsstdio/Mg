...
namespace Magnesium.Vulkan.Functions.Device
{
	public class VkCreateSwapchainKHRSection
	{
		...
		internal extern static MgResult vkCreateSwapchainKHR(IntPtr device, [In, Out] VkSwapchainCreateInfoKHR pCreateInfo, IntPtr pAllocator, ref UInt64 pSwapchain);
