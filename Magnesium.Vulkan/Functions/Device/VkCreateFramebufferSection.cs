...
namespace Magnesium.Vulkan.Functions.Device
{
	public class VkCreateFramebufferSection
	{
		...
		internal extern static MgResult vkCreateFramebuffer(IntPtr device, [In, Out] VkFramebufferCreateInfo pCreateInfo, IntPtr pAllocator, ref UInt64 pFramebuffer);
