...
### Version 5.2.7
 ...
 - Magnesium.OpenGL v6.0.5
 - Magnesium.OpenGL.DesktopGL v6.0.5
...
|-----------|----------|-----------|
| [Magnesium](https://www.nuget.org/packages/Magnesium/) | 5.2.7-beta  | Core C# Vulkan interface with all applications should reference |
| [Magnesium.Vulkan](https://www.nuget.org/packages/Magnesium.Vulkan/) | 5.0.7-beta | C# interface to Vulkan version 1.0.17 |
...
| [Magnesium.OpenGL](https://www.nuget.org/packages/Magnesium.OpenGL/) | 6.0.5-beta  | OpenGL enumation/polyfill to replicate most of Vulkan entities and features |
| [Magnesium.OpenGL.DesktopGL](https://www.nuget.org/packages/Magnesium.OpenGL.DesktopGL/) | 6.0.5-beta  | OpenTK / OpenGL 4.5 implementation |
| [Magnesium.PresentationSurfaces.OpenTK](https://www.nuget.org/packages/Magnesium.PresentationSurfaces.OpenTK/) | 1.0.4-beta  | Contains OpenTK implementation of IMgPresentationSurface for Vulkan & DesktopGL |
| [Magnesium.Ktx](https://www.nuget.org/packages/Magnesium.Ktx/) | 1.0.4-beta | Loads Khronos .ktx image files |
