...
{
	public class AmtQueue : IGLQueue
	{
        ...
        static AmtCommandRecording GenerateRecording(IGLCommandBuffer buffer, IAmtStateRenderer renderer)
        {
